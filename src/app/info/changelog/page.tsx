...
export default function ChangelogPage() {
    return (
        <div className="min-h-screen bg-background text-foreground relative font-sans selection:bg-cyan-500/30">
            {/* Background Layers */}
            ...
            <main className="flex-1 max-w-4xl w-full mx-auto p-8 py-20 relative z-10">
                ...
                <div className="mb-20">
                    ...
                    <h1 className="text-5xl font-extrabold text-foreground mb-6 tracking-tighter">Changelog</h1>
                ...
                {/* Timeline */}
                <div className="relative border-l border-border pl-8 md:pl-12 ml-4 md:ml-0 space-y-20">
                    
                    {/* Release 1.2.0 */}
                    <div className="relative">
                        {/* Timeline dot */}
                        <div className="absolute -left-[41px] md:-left-[57px] w-5 h-5 bg-background border-4 border-cyan-500 rounded-full shadow-[0_0_15px_rgba(6,182,212,0.5)]"></div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-2">
                            ...
                            <p className="text-muted-foreground font-medium">October 24, 2024</p>
                        </div>

                        <div className="mb-8 w-full h-64 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-border relative overflow-hidden flex items-center justify-center">
                        ...
                        <div className="space-y-8">
                            <section>
                                <h3 className="text-lg font-bold text-foreground flex items-center gap-2 mb-3"><Sparkles className="w-4 h-4 text-cyan-400"/> New Features</h3>
                            ...
                            <section>
                                <h3 className="text-lg font-bold text-foreground flex items-center gap-2 mb-3"><Wrench className="w-4 h-4 text-emerald-400"/> Improvements</h3>
                                <ul className="space-y-3 text-muted-foreground">
                    ...
                    {/* Release 1.1.0 */}
                    <div className="relative">
                        <div className="absolute -left-[41px] md:-left-[57px] w-5 h-5 bg-background border-4 border-border rounded-full"></div>
                        
                        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-2">
                            <h2 className="text-3xl font-bold text-foreground tracking-tight">Kidraw v1.1.0</h2>
                            <p className="text-muted-foreground font-medium">September 15, 2024</p>
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <section>
                                <h3 className="text-lg font-bold text-foreground flex items-center gap-2 mb-3"><Bug className="w-4 h-4 text-rose-400"/> Bug Fixes</h3>
                                <ul className="space-y-3 text-muted-foreground">
                    ...
                    <div className="relative opacity-60">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-2">
                            <h2 className="text-3xl font-bold text-foreground tracking-tight">Kidraw v1.0.0</h2>
                            <p className="text-muted-foreground font-medium">August 1, 2024</p>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <a href="#" className="inline-flex items-center gap-1 text-sm font-bold text-foreground hover:text-cyan-400 transition-colors">
