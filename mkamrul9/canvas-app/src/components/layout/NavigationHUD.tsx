...
import { Sparkles, Home, User, Settings, CreditCard, LogIn } from "lucide-react";
...
export default function NavigationHUD() {
    ...
    return (
        <div className="absolute z-50 top-6 left-6 flex items-center gap-3">
            {/* KIDRAW LOGO -> HOME */}
            <Link href="/" className="flex items-center gap-2 bg-[#0B0F19]/80 backdrop-blur-xl px-4 py-2 rounded-xl shadow-2xl border border-white/10 hover:bg-white/5 hover:scale-105 transition-all">
            ...
            <DropdownMenu>
                <DropdownMenuTrigger className="outline-none">
                    <Avatar className="h-10 w-10 border-2 border-white/10 shadow-lg ring-2 ring-transparent hover:ring-violet-500 transition-all cursor-pointer">
                ...
                <DropdownMenuContent align="start" className="w-64 p-2 rounded-xl bg-[#0B0F19] border-white/10 text-slate-50 shadow-2xl">
                    ...
                    <DropdownMenuGroup className="py-1">
                        <Link href="/">
                            <DropdownMenuItem className="cursor-pointer focus:bg-violet-600 focus:text-white rounded-md text-slate-300 transition-colors">
                                <Home className="w-4 h-4 mr-2" /> Dashboard Home
                            </DropdownMenuItem>
                        </Link>
                    </DropdownMenuGroup>
